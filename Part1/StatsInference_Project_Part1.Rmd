...
The full source code to this report and other files can be found [here](https://github.com/seleregb/Statistical_Inference-Coursera/blob/master/Part1/StatsInference_Project__Part1.R)